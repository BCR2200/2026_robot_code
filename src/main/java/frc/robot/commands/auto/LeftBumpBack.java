...
public class LeftBumpBack extends AutoCommand {

    private PathPlannerPath path;
    
    public LeftBumpBack(RobotContainer robot, CommandSwerveDrivetrain drivetrain, SwerveRequest.RobotCentric swerve) {
        path = AutoBuildingBlocks.loadPathOrThrow("LeftBumpBack.1");
