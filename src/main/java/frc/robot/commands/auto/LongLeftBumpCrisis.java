...
public class LongLeftBumpCrisis extends AutoCommand {

    private PathPlannerPath path1;
    private PathPlannerPath path2;
    
    public LongLeftBumpCrisis(RobotContainer robot, CommandSwerveDrivetrain drivetrain, SwerveRequest.RobotCentric swerve) {
        path1 = AutoBuildingBlocks.loadPathOrThrow("LongLeftBumpCrisis.1");
