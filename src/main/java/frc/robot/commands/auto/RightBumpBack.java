...
public class RightBumpBack extends AutoCommand {

    private PathPlannerPath path;
    
    public RightBumpBack(RobotContainer robot, CommandSwerveDrivetrain drivetrain, SwerveRequest.RobotCentric swerve) {
        path = AutoBuildingBlocks.loadPathOrThrow("RightBumpBack.1");
