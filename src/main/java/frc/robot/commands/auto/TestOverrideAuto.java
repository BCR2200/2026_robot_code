...
public class TestOverrideAuto extends AutoCommand{
    private final PathPlannerPath path1;

    public TestOverrideAuto (RobotContainer robot, CommandSwerveDrivetrain drivetrain, SwerveRequest.RobotCentric swerve) {
        path1 = AutoBuildingBlocks.loadPathOrThrow("TestOverrideAuto");
        addCommands(
